#!/bin/bash -x
#SBATCH -J maharashtra_sweep # A single job name for the array
...
python3 parameter_sweep_maharashtra.py $1 $2 --index ${SLURM_ARRAY_TASK_ID} --sim_name $3 --seed_offset $4
