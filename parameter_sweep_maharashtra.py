...
parser = argparse.ArgumentParser(description='Run maharashtra parameter sweeps in a distributed way.')
...
parser.add_argument('--sim_name', type=str, default="maharashtra_batch", help='Always specify a new directory for your jobs!')
...
data = pd.read_csv('validation_data/India/maharashtra_data_deaths.csv')
dates = []
actual_deaths = []
...
country_list=['China','France', 'Germany', 'Iran', 'Italy',  'Spain', 'Switzerland',
              'Republic of Korea', 'UK', 'USA', 'India']
